...
|---|---|---|---|---|
| philippines_2025_elections_2025_results | Google drive (Scraped by my colleague) | 20,138,578 | 3.8GB | Long |
...
- `partylist-25` and `senate-25` have a wide dataset type and they contain more information regarding votes (including valid ballots, over votes, under votes, and valid votes).
  As compared to `philippines_2025_elections` which has two columns that specify `votes`, `voters`, and` `total_votes` it does not go into detail
  on what type of votes they are. 
